...
/* 'period' is how many times a second your thread needs to run (0 if you're running continuously.) */
...
/* PLAYBACK and RECORDING means threads feeding/reading actual devices only. */
/* 0 means don't care */
enum { /* bitmasks for "what" */
	...
	B_LIVE_VIDEO_MANIPULATION = 0x8,
	B_VIDEO_PLAYBACK = 0x10,
	B_VIDEO_RECORDING = 0x20,
	B_LIVE_AUDIO_MANIPULATION = 0x40,	/* non-live rendering is OFFLINE_PROCESSING */
	B_AUDIO_PLAYBACK = 0x80,
...
extern "C" {
_IMPEXP_ROOT int32 suggest_thread_priority(uint32 what = B_DEFAULT_MEDIA_PRIORITY, 
