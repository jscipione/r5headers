...
extern ssize_t __readlink __P ((__const char *__path, char *__buf, size_t __len));
extern ssize_t readlink __P ((__const char *__path, char *__buf, size_t __len));
#endif /* Use BSD.  */
